...
class TestUser:
    ...
    # 参数化，yaml数据驱动
    @pytest.mark.parametrize('base_info,testcase', get_testcase_yaml("./testcase/UserManager/addUser.yaml"))
    ...
    @pytest.mark.parametrize('base_info,testcase', get_testcase_yaml("./testcase/UserManager/updateUser.yaml"))
    ...
    @pytest.mark.parametrize('base_info,testcase', get_testcase_yaml("./testcase/UserManager/deleteUser.yaml"))
